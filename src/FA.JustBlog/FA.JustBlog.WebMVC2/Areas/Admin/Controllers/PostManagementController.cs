...
namespace FA.JustBlog.WebMVC2.Areas.Admin.Controllers
{
    public class PostManagementController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,ShortDescription,ImageUrl,PostContent,UrlSlug,Published,PublishedDate,ViewCount,RateCount,TotalRate,CategoryId,IsDeleted,InsertedAt,UpdatedAt")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,ShortDescription,ImageUrl,PostContent,UrlSlug,Published,PublishedDate,ViewCount,RateCount,TotalRate,CategoryId,IsDeleted,InsertedAt,UpdatedAt")] Post post)
        {
            if (ModelState.IsValid)
            {
